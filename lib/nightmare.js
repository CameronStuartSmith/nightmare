...
const shouldMock = !!process.versions['electron']

/**
 * Export `Nightmare`
 */

// const shouldMock = (function() {
// 	return process.env._.endsWith('electron')
// })()

module.exports = Nightmare
module.exports.shouldMock = shouldMock;
/**
 * runner script
 */
...
function Nightmare(options) {
  ...
  this.queue(done => {
	...
	if (shouldMock) {
		...
		console.log('bought to call app ready');
		setTimeout(() => {
